...
class _BaseADeepCI:
    ...
    def _pretrain(self, X_1_a_j, X_2_a_j, X_1_a_k, X_2_a_k, 
        ...
        return X_1_a_j, X_2_a_j, X_1_a_k, X_2_a_k, 
                  X_1_b_j, X_2_b_j, X_1_b_k, X_2_b_k, Z
...
class _BaseSupLossADeepCI(_BaseADeepCI):
    ...
    def fit(self, X_1_a_j, X_2_a_j, X_1_a_k, X_2_a_k, 
        ...
        X_1_a_j, X_2_a_j, X_1_a_k, X_2_a_k, 
                  X_1_b_j, X_2_b_j, X_1_b_k, X_2_b_k, Z = self._pretrain(X_1_a_j, X_2_a_j, X_1_a_k, X_2_a_k, 
                                  X_1_b_j, X_2_b_j, X_1_b_k, X_2_b_k, Z,
                                 learner_l2, adversary_l2, adversary_norm_reg,
                                 learner_lr, adversary_lr, n_epochs, bs, train_learner_every, train_adversary_every,
        ...
        for epoch in range(n_epochs):
            ...
            for it, (x_1_a_j_batch, x_2_a_j_batch, x_1_a_k_batch, x_2_a_k_batch, 
                ...
                x_1_a_j_batch, x_2_a_j_batch, x_1_a_k_batch, x_2_a_k_batch, 
                  x_1_b_j_batch, x_2_b_j_batch, x_1_b_k_batch, x_2_b_k_batch, z_batch = map(lambda x: x.to(device), (x_1_a_j_batch, 
                                                                x_2_a_j_batch, x_1_a_k_batch, x_2_a_k_batch, 
                                                                x_1_b_j_batch, x_2_b_j_batch, x_1_b_k_batch, x_2_b_k_batch, 
                                                                                                                    z_batch))
                ...
                if (it % train_learner_every == 0):
                    ...
                    test = self.adversary(z_batch)
                    m = ([x_1_a_j_batch - x_1_a_k_batch] + \
                            [x_1_b_k_batch - x_1_b_j_batch] + \
                             [pred_a_j - pred_a_k] + \
                             [pred_b_k - pred_b_j])*test
                    D_loss = torch.maximum(0,torch.mean(-1*(m)))**2  
                ...
                if (it % train_adversary_every == 0):
                    ...
                    m = ([x_1_a_j_batch - x_1_a_k_batch] + \
                            [x_1_b_k_batch - x_1_b_j_batch] + \
                             [pred_a_j - pred_a_k] + \
                             [pred_b_k - pred_b_j])*test
                    G_loss = - torch.maximum(0,torch.mean(-1*(m)))**2  + torch.mean(test**2) #regularizer for instrument
